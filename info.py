...
LOG_CHANNEL = [int(lc) if id_pattern.search(lc) else lc for lc in environ.get('LOG_CHANNEL', '-1002801544620').split()]  # Log channel id (make sure bot is admin)
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://akku:akku@cluster0.7smnpac.mongodb.net/?appName=Cluster0")
